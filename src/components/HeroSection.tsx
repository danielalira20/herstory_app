      ...
      <nav className="absolute top-0 left-0 right-0 z-50 p-6">
        <div className="max-w-7xl mx-auto flex justify-end">
          <motion.button
            ...
            whileTap={{ scale: 0.98 }}
            className="text-white/90 hover:text-white font-medium px-6 py-2 rounded-full border border-pink-300/30 hover:border-pink-300/50 hover:bg-pink-300/10 transition-all duration-300"
          >
            Iniciar Sesión
          </motion.button>
        </div>
